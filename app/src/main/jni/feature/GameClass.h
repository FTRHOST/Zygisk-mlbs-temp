...
#define SystemData_RoomData_vUnLockHeroInRank (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vUnLockHeroInRank")
#define SystemData_RoomData_uiEquipSuit (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiEquipSuit")
#define SystemData_RoomData_vOperBanHero (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vOperBanHero")
#define SystemData_RoomData_iHeroEnhanceLevel (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iHeroEnhanceLevel")
#define SystemData_RoomData_uiMagicChessCupNum (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiMagicChessCupNum")
#define SystemData_RoomData_uiMagicRankID (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiMagicRankID")
#define SystemData_RoomData_uiAerocraftId (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiAerocraftId")
#define SystemData_RoomData_uiAerocraftSkinId (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiAerocraftSkinId")
#define SystemData_RoomData_uiCupCount (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiCupCount")
#define SystemData_RoomData_uiBattleCount (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiBattleCount")
#define SystemData_RoomData_heroShowSkin (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "heroShowSkin")
#define SystemData_RoomData_uiMatchScore (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiMatchScore")
#define SystemData_RoomData_iStarVipSkinRank (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iStarVipSkinRank")
#define SystemData_RoomData_vSkinAction (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vSkinAction")
#define SystemData_RoomData_uiBattleAIPerformanceScore (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiBattleAIPerformanceScore")
#define SystemData_RoomData_uiLocalAIPerformanceScore (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiLocalAIPerformanceScore")
#define SystemData_RoomData_uiTemperatureGrade (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiTemperatureGrade")
#define SystemData_RoomData_bBattleAIWhilteList (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bBattleAIWhilteList")
#define SystemData_RoomData_bOpenTryRune (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bOpenTryRune")
#define SystemData_RoomData_uiBattleAIDiffculty (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiBattleAIDiffculty")
#define SystemData_RoomData_uiBattleAIDiffcultyMin (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiBattleAIDiffcultyMin")
#define SystemData_RoomData_uiBattleAIDiffcultyMax (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiBattleAIDiffcultyMax")
#define SystemData_RoomData_bWarmBattleAIRobot (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bWarmBattleAIRobot")
#define SystemData_RoomData_uiRobotAICompany (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiRobotAICompany")
#define SystemData_RoomData_uiPlayerFov (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiPlayerFov")
#define SystemData_RoomData_uiCameraProjection (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiCameraProjection")
#define SystemData_RoomData_uiArenaRankID (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiArenaRankID")
#define SystemData_RoomData_uiArenaCupNum (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiArenaCupNum")
#define SystemData_RoomData_bFaceHD (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bFaceHD")
#define SystemData_RoomData_bLuckyDogFreeHero (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bLuckyDogFreeHero")
#define SystemData_RoomData_bLuckyDogFreeSkin (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bLuckyDogFreeSkin")
#define SystemData_RoomData_iHistoryMaxBigRankId (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iHistoryMaxBigRankId")
#define SystemData_RoomData_uiArenaBigRankID (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiArenaBigRankID")
#define SystemData_RoomData_bDropSpecialItemInDayBreak (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bDropSpecialItemInDayBreak")
#define SystemData_RoomData_bFakeRole (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bFakeRole")
#define SystemData_RoomData_bVP (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bVP")
#define SystemData_RoomData_uiCloneImbaDisorderSpecialResource (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiCloneImbaDisorderSpecialResource")
#define SystemData_RoomData_vFriendShareHero (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vFriendShareHero")
#define SystemData_RoomData_vPartyEffect (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vPartyEffect")
#define SystemData_RoomData_bInspire (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bInspire")
#define SystemData_RoomData_uiRandomScroeItem (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiRandomScroeItem")
#define SystemData_RoomData_iPartyTitle (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iPartyTitle")
#define SystemData_RoomData_bRoomLeader (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "bRoomLeader")
#define SystemData_RoomData_vExtraSummons (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vExtraSummons")
...
#define SystemData_RoomData_iMatchPhaseId (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iMatchPhaseId")
#define SystemData_RoomData_vAllPlayerTitle (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vAllPlayerTitle")
#define SystemData_RoomData_iTeamMatchBONum (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iTeamMatchBONum")
#define SystemData_RoomData_iTeamMatchRank (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iTeamMatchRank")
#define SystemData_RoomData_dragonCrystalId (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "dragonCrystalId")
#define SystemData_RoomData_iBoolHolder (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iBoolHolder")
#define SystemData_RoomData_iRoguelikeTeamID (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iRoguelikeTeamID")
#define SystemData_RoomData_iChatEffectId (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iChatEffectId")
#define SystemData_RoomData_iMirrorBattleID (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iMirrorBattleID")
#define SystemData_RoomData_vFiveFreeSkin (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vFiveFreeSkin")
#define SystemData_RoomData_uiCurtainId (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "uiCurtainId")
#define SystemData_RoomData_ulFakeRoleRoomID (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "ulFakeRoleRoomID")
#define SystemData_RoomData_vDisOrderUnlockHero (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "vDisOrderUnlockHero")
#define SystemData_RoomData_iForbidBattleMessageTime (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iForbidBattleMessageTime")
#define SystemData_RoomData_iButtonSkin (uintptr_t) Il2CppGetFieldOffset("Assembly-CSharp.dll", "", "SystemData/RoomData", "iButtonSkin")
